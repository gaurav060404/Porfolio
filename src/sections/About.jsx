        ...
        <section id="about" className="c-space section-spacing">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
                ...
                <div className="flex items-end grid-default-color grid-1">
                    ...
                    />
                    <div className="z-10">
                        <p className="headtext">Hi, I'm Gourav Singh
                        </p>
                        <p className="subtext">
                            Over the last 1.5 year, I have been developing my frontend and backend dev
                ...
                <div className="grid-default-color grid-2">
                    <div ref={grid2Container} className="flex items-center justify-center w-full h-full">
                        ...
                        <Card style={{ rotate: "-75deg", top: "55%", left: "0%" }} text="Design Principles" containerRef={grid2Container}/>
                        ...
                        <Card style={{ rotate: "-45deg", top: "5%", left: "10%" }}
                            image="assets/logos/git.svg" containerRef={grid2Container}/>
                    </div>
                </div>
                {/* Grid 3 */}
                <div className="flex items-end grid-black-color grid-3">
                    <div className="z-10 w-[50%]">
                        ...
                        <p className="subtext">I'm based in Arrakis, and open to remote work</p>
                    </div>
                    <figure className="absolute left-[25%] top-[0.2%]">
                        <Globe/>
                    </figure>
                </div>
                {/* Grid 4 */}
