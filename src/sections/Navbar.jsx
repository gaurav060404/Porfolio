...
function Navigation() {
    ...
    return (
        <ul className='nav-ul'>
            ...
            <li className='nav-li'>
                <a className='nav-link' href="#projects" onClick={(e) => handleClick(e, 'projects')}>Projects</a>
            </li>
            <li className='nav-li'>
                <a className='nav-link' href="#experience" onClick={(e) => handleClick(e, 'experience')}>Experience</a>
            </li>
            <li className='nav-li'>
        ...
        <div className='fixed inset-x-0 z-20 w-full backdrop-blur-lg bg-primary/40'>
            ...
            {isOpen &&
                ...
                className='block overflow-hidden text-center sm:hidden'>
                    <nav className='pb-5' onClick={toggleMenu}>
                        <Navigation />
                    </nav>
                </motion.div>)}
        </div>
